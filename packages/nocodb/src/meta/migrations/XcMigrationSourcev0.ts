...
import * as nc_202605221700_form_save_draft_to_browser from './v0/nc_202605221700_form_save_draft_to_browser';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202605221700_form_save_draft_to_browser',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202605221700_form_save_draft_to_browser':
        return nc_202605221700_form_save_draft_to_browser;
    }
  }
}
